...
[![Coverage Status](https://coveralls.io/repos/github/james947/Weconnect_react/badge.svg?branch=ch-test-config-with-mocha&service=github)](https://coveralls.io/github/james947/Weconnect_react?branch=ch-test-config-with-mocha)branch=ft-implement-actions-and-components-tests-158894959)
